...
package Bugzilla::WebService::Server::REST::Resources::Classifications;
...
use Bugzilla::WebService::Classifications;

BEGIN {
  *Bugzilla::WebService::Classifications::rest_resources = \&_rest_resources;
}
