...
package Bugzilla::API::1_0::Resource::Classifications;
...
sub get {
  ...
  my $classification_objs = $user->get_selectable_classifications;
...
sub _classification_to_hash {
  ...
  return filter $params,
    ...
    description => as_int($classification->description),
